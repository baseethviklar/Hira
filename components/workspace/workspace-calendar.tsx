                ...
                {totalDays.map((day, dayIdx) => {
                    ...
                    return (
                        <div
                            key={day.toString()}
                            className={cn(
                                "bg-background min-h-[120px] p-2 flex flex-col gap-1 transition-colors hover:bg-muted/50",
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-1 overflow-y-auto max-h-[100px] scrollbar-hide">
                                {daysIssues.map(issue => (
                                    <Link key={issue._id as unknown as string} href={`/projects/${issue.projectId}`}>
                                        <div className={cn(
